...
/**
 * Inspired by:
 * https://github.com/mcrisc/mock-resultset/blob/master/src/main/java/commondb/mock/MockResultSet.java
 */
public class MockResultSet implements ResultSet {
    ...
    public MockResultSet(List<String> columns, List<String> columnTypes) {
        this.columns = columns;
        this.columnTypes = columnTypes;
    }

    public MockResultSet addRow(String... values) {
        checkArgument(
                values.length == columns.size(), "Row must have " + columns.size() + " items");
        rowset.add(values);
        return this;
    }

    public MockResultSet subset(int offset, int size) {
        MockResultSet newSet = new MockResultSet(columns, columnTypes);
        newSet.rowset = this.rowset.subList(offset, offset + size);
        return newSet;
    }
    ...
    @Override
    /**
     * Dates are expected to be formatted as yyyy-MM-dd. See
    ...
    public ResultSetMetaData getMetaData() throws SQLException {
        return new Metadata(this.columns, this.columnTypes);
    }
