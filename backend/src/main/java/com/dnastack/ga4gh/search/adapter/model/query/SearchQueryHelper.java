...
import com.dnastack.ga4gh.search.adapter.model.serde.QuerySerializer;
...
public class SearchQueryHelper {
    ...
    public static Query deserializeFromString(String jsonString) throws IOException {
        return objectMapper().readValue(jsonString, Query.class);
    }
